...
export class RegisterDoctorComponent implements OnInit {
  ...
  register(){
    if(this.password != this.passwordConf){
      ...
      this.registerService.registerDoctor(this.username, this.password, this.name, this.surname, this.address, this.phone, this.email, this.licenceNum, this.specialisation, this.branch, this.imageSrc).subscribe(()=>{
        alert("Uspesno registrovan lekar!");
        this.name = this.surname = this.username = this.password = this.passwordConf = this.address = this.phone = this.email = this.licenceNum = this.specialisation = this.branch = this.imageSrc = "";
      });
    }
  }
